   ...
   <section class="header">
    ...
    <section class="conatiner">
        <div class="card-body" style="text-align: center; background-color: lightgreen; border-radius: 15px; margin-top: 1rem;">
            <br>
            <h1 class="h1"><strong>Recommended Activities in CEDAR</strong></h1>
            <div class="container mt-5">
                <div class="row g-4">

                    <div class="col-md-4">
                        <div class="card bg-success">
                            <img src="images/cedar_act/picnic.png" class="card-img-top">
                            <div class="card">
                    ...
                    <div class="col-md-4">
                        <div class="card bg-success">
                            <img src="images/cedar_act/swimming.png" class="card-img-top">
                            <div class="card">
                    ...
                    <div class="col-md-4">
                        <div class="card bg-success ">
                            <img src="images/cedar_act/outing.png" class="card-img-top">
                            <div class="card">
                                <h5 class="h1">Family Outing</h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card bg-success">
                            <img src="images/cedar_act/hiking.png" class="card-img-top">
                            <div class="card">
                                <h5 class="h1">Hiking</h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card bg-success">
                            <img src="images/cedar_act/backpacking.png" class="card-img-top">
                            <div class="card">
                                <h5 class="h1">Backpacking</h5>
                            </div>
                        </div>
                    </div>
                </div>
