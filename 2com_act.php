   ...
   <section class="header">
    ...
    <section class="conatiner">
        <div class="card-body" style="text-align: center; background-color: lightgreen; border-radius: 15px; margin-top: 1rem;">
            <br>
            <h1 class="h1"><strong>Recommended Activities in Communal Ranch</strong></h1>
            <div class="container mt-5">
                <div class="row g-4">

                    <div class="col-md-4">
                        <div class="card bg-success">
                            <img src="images/com_act/horse.jpg" class="card-img-top">
                            <div class="card">
                                <h5 class="h1">Horse Riding</h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card bg-success">
                            <img src="images/com_act/camping.jpg" class="card-img-top">
                            <div class="card">
                                <h5 class="h1">Camping / Picnic</h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card bg-success ">
                            <img src="images/com_act/hiking.jpg" class="card-img-top">
                            <div class="card">
                                <h5 class="h1">SHiking / Backpacking</h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card bg-success">
                            <img src="images/com_act/mount-view.jpg" class="card-img-top">
                            <div class="card">
                                <h5 class="h1">Mountain Viewing</h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card bg-success">
                            <img src="images/com_act/prenup.jpg" class="card-img-top">
                            <div class="card">
                                <h5 class="h1">Prenup Photoshot</h5>
                            </div>
                        </div>
                    </div>
                </div>
