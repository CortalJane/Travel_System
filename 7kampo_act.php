   ...
   <section class="header">
    ...
    <section class="conatiner">
        <div class="card-body" style="text-align: center; background-color: lightgreen; border-radius: 15px; margin-top: 1rem;">
            <br>
            <h1 class="h1"><strong>Recommended Activities in Kampo Juan Eco-Adventure Farm</strong></h1>
            <div class="container mt-5">
                <div class="row g-4">

                    <div class="col-md-4">
                        <div class="card bg-success">
                            <img src="images/kampo_act/canopy_walk.png" class="card-img-top">
                            <div class="card">
                                <h5 class="h1">Canopy Walk</h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card bg-success ">
                            <img src="images/kampo_act/anicycling.png" class="card-img-top">
                            <div class="card">
                                <h5 class="h1">Anicycling</h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card bg-success">
                            <img src="images/kampo_act/zipline.png" class="card-img-top">
                            <div class="card">
                                <h5 class="h1">Ziplining</h5>
                            </div>
                        </div>
                    </div>
                </div>
