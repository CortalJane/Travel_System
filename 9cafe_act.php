   ...
   <section class="header">
    ...
    <section class="conatiner">
        <div class="card-body" style="text-align: center; background-color: lightgreen; border-radius: 15px; margin-top: 1rem;">
            <br>
            <h1 class="h1"><strong>Recommended Activities in Cafe sa Bukid</strong></h1>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-4">
                        <div class="card bg-success">
                            <img src="images/cafe_act/breakfast.png" class="card-img-top">
                            <div class="card">
                                <h5 class="h1">Breakfast & Lunch</h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card bg-success ">
                            <img src="images/cafe_act/unwind.png" class="card-img-top">
                            <div class="card">
                    ...
                    <div class="col-md-4">
                        <div class="card bg-success">
                            <img src="images/cafe_act/chilling.png" class="card-img-top">
                            <div class="card">
