   ...
   <section class="header">
    ...
    <section class="conatiner">
        <div class="card-body" style="text-align: center; background-color: lightgreen; border-radius: 15px; margin-top: 1rem;">
            <br>
            <h1 class="h1"><strong>Recommended Activities in Tourism Center</strong></h1>
            <div class="container mt-5">
                <div class="row g-4">

                    <div class="col-md-4">
                        <div class="card bg-success">
                            <img src="images/tourism_act/panika.png" class="card-img-top">
                            <div class="card">
                                <h5 class="h3">"Panika" symbolized as Integrity of our Women</h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card bg-success ">
                            <img src="images/tourism_act/photoshooting.png" class="card-img-top">
                            <div class="card">
                                <br>
                                <h5 class="h2">Photoshooting</h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card bg-success">
                            <img src="images/tourism_act/ethnic_statues.png" class="card-img-top">
                            <div class="card">
                                <br>
                                <h5 class="h2">Ethnic Statues</h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card bg-success">
                            <img src="images/tourism_act/heritage.png" class="card-img-top">
                            <div class="card">
                                <br>
                                <h5 class="h2">Engrave Heritage</h5>
                            </div>
                        </div>
                    </div>
                </div>
