   ...
   <section class="header">
    ...
    <section class="conatiner">
        <div class="card-body" style="text-align: center; background-color: lightgreen; border-radius: 15px; margin-top: 1rem;">
            <br>
            <h1 class="h1"><strong>Recommended Activities in Ultra Winds Mountain Resort</strong></h1>
            <div class="container mt-5">
                <div class="row g-4">

                    <div class="col-md-4">
                        <div class="card bg-success">
                            <img src="images/ultra_act/swimming.png" class="card-img-top">
                            <div class="card">
                                <br>
                    ...
                    <div class="col-md-4">
                        <div class="card bg-success ">
                            <img src="images/ultra_act/family_bonding.png" class="card-img-top">
                            <div class="card">
                                <br>
                    ...
                    <div class="col-md-4">
                        <div class="card bg-success">
                            <img src="images/ultra_act/night_swimming.png" class="card-img-top">
                            <div class="card">
                                <br>
                                <h5 class="h1">Other activities</h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card bg-success">
                            <img src="images/ultra_act/other_act.png" class="card-img-top">
                            <div class="card">
                                <br>
                                <h5 class="h1">Engrave Heritage</h5>
                            </div>
                        </div>
                    </div>
                </div>
