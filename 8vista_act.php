   ...
   <section class="header">
    ...
    <section class="conatiner">
        <div class="card-body" style="text-align: center; background-color: lightgreen; border-radius: 15px; margin-top: 1rem;">
            <br>
            <h1 class="h1"><strong>Recommended Activities in Vista West Cafe</strong></h1>
            <h2 class="h4"><strong>You can also enjoy having your breakfast and lunch here!</strong></h2>
            <div class="container mt-5">
                <div class="row g-4">

                    <div class="col-md-4">
                        <div class="card bg-success">
                            <img src="images/vista_act/mountain_viewing.png" class="card-img-top">
                            <div class="card">
                    ...
                    <div class="col-md-4">
                        <div class="card bg-success ">
                            <img src="images/vista_act/drone.png" class="card-img-top">
                            <div class="card">
                    ...
                    <div class="col-md-4">
                        <div class="card bg-success">
                            <img src="images/vista_act/family_bonding.png" class="card-img-top">
                            <div class="card">
