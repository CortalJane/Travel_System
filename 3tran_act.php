   ...
   <section class="header">
    ...
    <section class="conatiner">
        <div class="card-body" style="text-align: center; background-color: lightgreen; border-radius: 15px; margin-top: 1rem;">
            <br>
            <h1 class="h1"><strong>What's in Tranfiguration Monastry?</strong></h1>
            <div class="container mt-5">
                <div class="row g-4">

                    <div class="col-md-4">
                        <div class="card bg-success ">
                            <img src="images/tran_act/church.png" class="card-img-top">
                            <div class="card">
                                <br>
                                <br>
                                <h5 class="h1">Church</h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card bg-success">
                            <img src="images/tran_act/masterpieces.png" class="card-img-top">
                            <div class="card">
                                <h5 class="h1">Architecture Leandro Locsin’s masterpieces</h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card bg-success">
                            <img src="images/tran_act/songs.png" class="card-img-top">
                            <div class="card">
                                <h5 class="h1">Benedictine Monk’s songs and chants</h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card bg-success">
                            <img src="images/tran_act/mass.png" class="card-img-top">
                            <div class="card">
                                <h5 class="h1">Prayer Gathering</h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card bg-success">
                            <img src="images/tran_act/collection.png" class="card-img-top">
                            <div class="card">
                                <h5 class="h1">Collection</h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card bg-success">
                            <img src="images/tran_act/collection2.png" class="card-img-top">
                            <div class="card">
                                <h5 class="h1">Church's History</h5>
                            </div>
                        </div>
                    </div>
                </div>
