   ...
   <section class="header">
    ...
    <section class="conatiner">
        <div class="card-body" style="text-align: center; background-color: lightgreen; border-radius: 15px; margin-top: 1rem;">
            <br>
            <h1 class="h1"><strong>Recommended Activities in Chelly's Restaurant</strong></h1>
            <div class="container mt-5">
                <div class="row g-4">

                    <div class="col-md-4">
                        <div class="card bg-success">
                            <img src="images/chelly's_act/breakfast_lunch.png" class="card-img-top">
                            <div class="card">
                                <br>
                    ...
                    <div class="col-md-4">
                        <div class="card bg-success ">
                            <img src="images/chelly's_act/dates.png" class="card-img-top">
                            <div class="card">
                                <br>
                    ...
                    <div class="col-md-4">
                        <div class="card bg-success">
                            <img src="images/chelly's_act/unwind.png" class="card-img-top">
                            <div class="card">
                                <br>
                                <h5 class="h2">Unwind</h5>
                            </div>
                        </div>
                    </div>
                </div>
