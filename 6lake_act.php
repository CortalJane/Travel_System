   ...
   <section class="header">
    ...
    <section class="conatiner">
        <div class="card-body" style="text-align: center; background-color: lightgreen; border-radius: 15px; margin-top: 1rem;">
            <br>
            <h1 class="h1"><strong>Recommended Activities in Lake Apo</strong></h1>
            <div class="container mt-5">
                <div class="row g-4">

                    <div class="col-md-4">
                        <div class="card bg-success">
                            <img src="images/lake_act/picnic.png" class="card-img-top">
                            <div class="card">
                                <h5 class="h1">Picnic</h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card bg-success ">
                            <img src="images/lake_act/family_bonding.png" class="card-img-top">
                            <div class="card">
                                <h5 class="h1">Family Bonding</h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card bg-success">
                            <img src="images/lake_act/swimming.png" class="card-img-top">
                            <div class="card">
                                <h5 class="h1">Swimming</h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card bg-success">
                            <img src="images/lake_act/photoshot.png" class="card-img-top">
                            <div class="card">
                                <h5 class="h1">Photo Shooting</h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card bg-success">
                            <img src="images/lake_act/bonfire.png" class="card-img-top">
                            <div class="card">
                                <h5 class="h1">Bonfire</h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card bg-success">
                            <img src="images/lake_act/jet_skiing.png" class="card-img-top">
                            <div class="card">
                                <h5 class="h1">Jet Skiing</h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card bg-success">
                            <img src="images/lake_act/kayak.png" class="card-img-top">
                            <div class="card">
                                <h5 class="h1">Kayak or Canoe</h5>
                            </div>
                        </div>
                    </div>
                </div>
